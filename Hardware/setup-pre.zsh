...
# Substitute variables in post script
sed -i "s|__DISK__|$DISK|g;s|__HOSTNAME__|$HOSTNAME|g;s|__LOCALE__|$LOCALE|g;s|__TIMEZONE__|$TIMEZONE|g;s|__ROOTPW__|$ROOT_PW|g;s|__MODE__|$MODE|g" /mnt/setup-post.zsh

echo ">>> setup-pre.zsh completed successfully! Now chroot and run setup-post.zsh"